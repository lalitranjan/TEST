...
public class Swagger3RestController {
	...
	@RequestMapping(value = "/postUser", method = RequestMethod.POST, produces = "application/json", consumes = "application/json")
	public User getUserByRole(@RequestBody User inputUser) {
		User myUser = new User();
		myUser.setId(inputUser.getId());
		myUser.setName(inputUser.getName());
		myUser.setRole(inputUser.getRole());
		myUser.setEmail(inputUser.getEmail());
		return myUser;
